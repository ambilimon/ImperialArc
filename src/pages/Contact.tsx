...
const Contact = () => {
  ...
  const offices = [
    {
      city: 'Dubai',
      address: 'The Exchange Tower - 105 - Business Bay - Dubai - United Arab Emirates',
      phone: '+971 58 584 4383',
      email: 'dubai@imperialarc.ae',
      hours: 'Open 365 days a year, 9 am to 5 pm'
    },
    {
      city: 'Abu Dhabi',
          ...
          <div className="bg-white shadow-xl p-8 max-w-md w-full">
            <div className="flex items-center mb-4">
              ...
              <div>
                ...
                <p className="text-gray-600">The Exchange Tower - 105 - Business Bay - Dubai</p>
              </div>
            </div>
            <div className="border-t border-gray-200 pt-4">
              <p className="text-gray-600 mb-4">
                Our main design studio is located in the Exchange Tower, Business Bay, Dubai's dynamic business district.
              </p>
