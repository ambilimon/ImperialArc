        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div>
            <img 
              ...
              alt="ImperialArc" 
              className="h-36 mb-6" // Increased logo size dramatically
            />
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li>
                <Link to="/" className="text-gray-300 hover:text-imperial-gold transition-colors duration-300">Home</Link>
              </li>
              <li>
                <Link to="/about" className="text-gray-300 hover:text-imperial-gold transition-colors duration-300">About Us</Link>
              </li>
              <li>
                <Link to="/services" className="text-gray-300 hover:text-imperial-gold transition-colors duration-300">Services</Link>
              </li>
              <li>
                <Link to="/projects" className="text-gray-300 hover:text-imperial-gold transition-colors duration-300">Projects</Link>
              </li>
              <li>
                <Link to="/contact" className="text-gray-300 hover:text-imperial-gold transition-colors duration-300">Contact</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li>
                <Link to="/services#retail" className="text-gray-300 hover:text-imperial-gold transition-colors duration-300">Retail Fit-out</Link>
              </li>
              <li>
                <Link to="/services#turnkey" className="text-gray-300 hover:text-imperial-gold transition-colors duration-300">Turnkey Projects</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex">
                <svg className="w-5 h-5 mr-3 text-imperial-gold" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
